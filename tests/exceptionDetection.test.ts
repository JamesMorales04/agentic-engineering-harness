...
function finding(category: string, exceptionType?: NormalizedFinding["exceptionType"]): NormalizedFinding { return { id: category, severity: "medium", category, location: { file: "x.ts" }, evidence: `evidence ${category}`, impact: "impact", recommendedFix: "fix", requiredCompetencies: ["testing"], reviewDimensions: ["correctness"], exceptionType }; }
