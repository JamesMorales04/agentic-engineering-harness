...
const jsonSchemas: Record<string, Record<string, unknown>> = {
  ...
  planner: { type: "object", additionalProperties: false, required: ["tasks"], properties: { tasks: { type: "array", items: delegationTaskJson }, affectedAreas: stringArray, requiredReviewers: stringArray, validationGates: stringArray, fallbackRouting: stringArray, outOfScopeImprovements: stringArray } },
