...
export interface AgentOverride { role?: AgentRole; domains?: string[]; execution?: Partial<AgentExecutionDefinition>; temperature?: number; skills?: string[]; mcps?: string[]; promptPath?: string; orchestratorPromptPath?: string; outputContract?: string; permissions?: AgentPermissions; capabilities?: string[]; disabled?: boolean; }
export interface AgentProfile { description?: string; models?: Record<string, Partial<ModelDefinition>>; agents?: Record<string, AgentOverride>; }
