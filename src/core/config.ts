...
const projectSchema = z.object({
  ...
  provenance: z.object({ outputDir: z.string().optional(), buildType: z.string().optional(), cosignKey: z.string().optional(), required: z.boolean().optional(), sbom: z.object({ required: z.boolean().optional(), command: z.string().min(1).optional() }).optional(), signing: z.object({ required: z.boolean().optional(), key: z.string().optional() }).optional(), verification: z.object({ required: z.boolean().optional(), publicKey: z.string().optional() }).optional() }).optional()
});
